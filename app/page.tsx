...
export default function HomePage() {
  ...
  // persist weekly outlook (debounced)
  useEffect(() => {
  ...
  return (
    <>
      ...
      {/* ===================== CHECKLIST ===================== */}
      <div id="checklist" className="page rdm-page section-anchor">
        <header>
      ...
      <div className="section-divider">
        <div className="line" />
        <div className="t">Weekly Outlook</div>
        <div className="line" />
      </div>

      <div id="semana" className="page wide wk-page section-anchor">
